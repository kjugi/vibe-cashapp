...
2. In [Google Cloud Console](https://console.cloud.google.com/apis/credentials) create an OAuth **Web application** client.
   - Authorized JavaScript origins: `http://localhost:5173` and your Vercel origin.
   - Authorized redirect URIs: the same origins with a trailing slash (`http://localhost:5173/`, `https://your-app.vercel.app/`).
